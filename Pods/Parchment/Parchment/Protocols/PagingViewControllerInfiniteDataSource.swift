...
public protocol PagingViewControllerInfiniteDataSource: class {
  ...
  func pagingViewController<T>(
    ...
    /// The `PagingItem` that comes before a given `PagingItem` + `withIndexOffset`
    ///
    /// - Parameter pagingViewController: The `PagingViewController`
    /// instance
    /// - Parameter pagingItemBeforePagingItem: A `PagingItem` instance
    ...
    func pagingViewController<T>(
        _ pagingViewController: PagingViewController<T>,
        pagingItemBeforePagingItem: T , withIndexOffset : Int) -> T?
    
    /// The `PagingItem` that comes after a given `PagingItem` + `withIndexOffset`
    ///
    /// - Parameter pagingViewController: The `PagingViewController`
    /// instance
    /// - Parameter pagingItemAfterPagingItem: A `PagingItem` instance
    ...
    func pagingViewController<T>(
        _ pagingViewController: PagingViewController<T>,
        pagingItemAfterPagingItem: T , withIndexOffset : Int) -> T?
    
    
    
    /// The *REAL* `PagingItem` that comes before a given `PagingItem`
    ///
    /// - Parameter pagingViewController: The `PagingViewController`
    /// instance
    /// - Parameter pagingItemBeforePagingItem: A `PagingItem` instance
    ...
    func pagingViewController<T>(
        _ pagingViewController: PagingViewController<T>,
        realPagingItemBeforePagingItem: T , isReal : Bool) -> T?
    
    /// The *REAL* `PagingItem` that comes after a given `PagingItem`
    ///
    /// - Parameter pagingViewController: The `PagingViewController`
    /// instance
    /// - Parameter pagingItemAfterPagingItem: A `PagingItem` instance
    ...
    func pagingViewController<T>(
        _ pagingViewController: PagingViewController<T>,
        realPagingItemAfterPagingItem: T ,isReal : Bool) -> T?
}
